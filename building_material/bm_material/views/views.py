...
def home(request):
    return render(request, 'bm_material/home.html')


# list view
class InputBillListView(PermissionRequiredMixin, ListView):
    permission_required = 'bm_material.view_inputbill'
    model = InputBill
    template_name = 'bm_material/list/list_input_bill.html'  # <app>/<model>_<viewtype>.html
    context_object_name = 'input_bills'
    ordering = ['-input_date']
    paginate_by = 10  # Số lượng phân trang

    def handle_no_permission(self):
        return redirect('bm_material-home')


class OutputBillListView(PermissionRequiredMixin, ListView):
    permission_required = 'bm_material.view_outputbill'
    model = OutputBill
    template_name = 'bm_material/list/list_output_bill.html'  # <app>/<model>_<viewtype>.html
...
class UserInputBillListView(ListView):
    model = InputBill
    template_name = 'bm_material/staff/staff_input_bill.html'  # <app>/<model>_<viewtype>.html
...
class UserOutputBillListView(ListView):
    model = OutputBill
    template_name = 'bm_material/staff/staff_output_bill.html'  # <app>/<model>_<viewtype>.html
...
class ProviderListView(ListView):
    model = Provider
    template_name = 'bm_material/list/list_provider.html'  # <app>/<model>_<viewtype>.html
...
class CustomerListView(ListView):
    model = Customer
    template_name = 'bm_material/list/list_customer.html'  # <app>/<model>_<viewtype>.html
...
class ProductListView(ListView):
    model = Product
    template_name = 'bm_material/list/list_product.html'  # <app>/<model>_<viewtype>.html
...
class WarehouseListView(ListView):
    model = Warehouse
    template_name = 'bm_material/warehouse/warehouse.html'  # <app>/<model>_<viewtype>.html
...
class InputBillCreateView(LoginRequiredMixin, CreateView):
    ...
    template_name = 'bm_material/input_bill/input_bill_form.html'
...
class OutputBillCreateView(LoginRequiredMixin, CreateView):
    ...
    template_name = 'bm_material/output_bill/output_bill_form.html'
...
class ProviderCreateView(LoginRequiredMixin, CreateView):
    ...
    template_name = 'bm_material/provider/provider_form.html'
...
class CustomerCreateView(LoginRequiredMixin, CreateView):
    ...
    template_name = 'bm_material/customer/customer_form.html'
...
class ProductCreateView(LoginRequiredMixin, CreateView):
    ...
    template_name = 'bm_material/product/product_form.html'
...
def create_detail_inputbill(request, pk):
    ...
    return render(request, 'bm_material/input_bill/detail_input_bill/input_bill_detail_form.html', context)
...
def create_detail_outputbill(request, pk):
    ...
    context = {'form': formset}
    return render(request, 'bm_material/output_bill/detail_output_bill/output_bill_detail_form.html', context)
...
class DetailInputUpdateView(LoginRequiredMixin, UpdateView, ABC):
    ...
    template_name = 'bm_material/input_bill/detail_input_bill/detail_bill_update.html'
    old_data = []
...
class DetailOutputUpdateView(LoginRequiredMixin, UpdateView, ABC):
    ...
    template_name = 'bm_material/output_bill/detail_output_bill/detail_bill_update.html'
    old_data = []
...
class InputBillDeleteView(LoginRequiredMixin, UserPassesTestMixin, DeleteView, ABC):
    model = InputBill
    success_url = '/list/input_bill'
    template_name = 'bm_material/input_bill/input_bill_confirm_delete.html'
...
class OutputBillDeleteView(LoginRequiredMixin, UserPassesTestMixin, DeleteView, ABC):
    model = OutputBill
    success_url = '/list/output_bill'
    template_name = 'bm_material/output_bill/output_bill_confirm_delete.html'
...
class ProviderDeleteView(LoginRequiredMixin, DeleteView, ABC):
    model = Provider
    success_url = '/list/provider'
    template_name = 'bm_material/provider/provider_confirm_delete.html'


class CustomerDeleteView(LoginRequiredMixin, DeleteView, ABC):
    model = Customer
    success_url = '/list/customer'
    template_name = 'bm_material/customer/customer_confirm_delete.html'


class ProductDeleteView(LoginRequiredMixin, DeleteView, ABC):
    model = Product
    success_url = '/list/product'
    template_name = 'bm_material/product/product_confirm_delete.html'


class DetailInputDeleteView(LoginRequiredMixin, DeleteView, ABC):
    model = DetailInputBill
    template_name = 'bm_material/input_bill/detail_input_bill/detail_bill_delete.html'
...
class DetailOutputDeleteView(LoginRequiredMixin, DeleteView, ABC):
    model = DetailOutputBill
    template_name = 'bm_material/output_bill/detail_output_bill/detail_bill_delete.html'
...
class ProviderDetailView(DetailView):
    model = Provider
    template_name = 'bm_material/provider/provider_detail.html'


class CustomerDetailView(DetailView):
    model = Customer
    template_name = 'bm_material/customer/customer_detail.html'


class ProductDetailView(DetailView):
    model = Product
    template_name = 'bm_material/product/product_detail.html'
...
def all_detail_input_bill(request, pk):
    ...
    return render(request, 'bm_material/input_bill/input_bill_detail.html', context)
...
def all_detail_output_bill(request, pk):
    ...
    # truyền vào các giá trị khác như bình thường, lưu ý phải có lưu dữ liệu ở phía trước
    return render(request, 'bm_material/output_bill/output_bill_detail.html', context)


# list page
def list_new(request):
    return render(request, 'bm_material/list/list_new.html')


def list_all(request):
    return render(request, 'bm_material/list/list_all.html')


def about(request):
    return render(request, 'bm_material/list/about.html')


def search(request):  # xây dựng hàm search
    template = 'bm_material/search.html'
...
def customer_shopping(request):
    template = "bm_material/customer/customer_shopping.html"
...
class UserShopping_Buying(ListView):    # danh sách hóa đơn đặt mua 
    model = Shopping
    template_name = 'bm_material/customer/customer_buying.html'  # <app>/<model>_<viewtype>.html
...
class UserShopping_Received(ListView): # danh sách hóa đơn đã nhận hàng
    model = Shopping
    template_name = 'bm_material/customer/customer_received.html'  # <app>/<model>_<viewtype>.html
    context_object_name = 'shoppings'  # using in template
    ordering = ['-buy_date']
    paginate_by = 9  # Số lượng phân trang
...
def List_typeProduct(request, type_product):
    template = "bm_material/product/list_type_product.html"
